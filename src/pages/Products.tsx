        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-8 max-w-xl mx-auto">
              We are launching our own private label line of premium dry food commodities. Emri Pinnacle Brand products
              will be available exclusively through our wholesale distribution network across the USA. Stay tuned for
      ...
      <section className="py-20">
        <div className="container text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
            Contact us with your product requirements, quantities, and delivery specifications. We will provide
            competitive pricing and availability within 24 hours.
          </p>
          <a
            href="/contact"
