          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="p-10 md:p-16 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                A Trusted Leader in USA Wholesale Distribution Founded in July 2024, Emri Pinnacle has become a trusted leader in USA wholesale distribution of dry food commodities and supermarket goods. With expertise in distribution operations, strategic sourcing, and domestic trade, the company is committed to delivering consistent quality and reliability through professional procurement processes and strong, long-term client relationships.
              </p>
